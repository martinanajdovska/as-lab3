...
if __name__ == '__main__':
    ...
    print(f"train reward: {train_reward / 30000} train steps: {train_steps / 30000}")
    ...
    for iteration in range(100):
        ...
        if iteration == 49:
            print(f"30000 Episodes reward {total_reward / 50} steps: {total_steps / 50}")

    print(f"30000 Episodes reward {total_reward / 100} steps: {total_steps / 100}")
