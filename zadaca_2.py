...
if __name__ == '__main__':
    ...
    agent = DDQN(state_space_shape, num_actions, model, model)
    ...
    for iteration in range(100):
        ...
        if iteration == 49:
            print(f"10000 Episodes reward {total_reward/50} steps: {total_steps/50}")

    print(f"10000 Episodes reward {total_reward/100} steps: {total_steps/100}")
    ...
    print(f"20000 ep train reward {train_reward/20000} steps {train_steps/20000}")
    ...
    for iteration in range(100):
        ...
        if iteration == 49:
            print(f"20000 ep total reward {total_reward/50} steps {total_steps/50}")

    print(f"20000 ep total reward {total_reward/100} steps {total_steps/100}")
